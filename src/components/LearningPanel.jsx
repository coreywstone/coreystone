...
const PODCAST_CARDS = [
  ...
  { id: 'state-of-play', src: '/img/podcasts/state-of-play.webp', alt: 'State of Play Podcast', url: 'https://www.uxtools.co/episodes', baseZ: 5, description: 'State of Play has convos with limit-pushing designers & builders.', name: 'State of Play', backBg: '#161E20' },
